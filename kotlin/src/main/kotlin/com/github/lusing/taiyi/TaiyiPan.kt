...
class TaiyiPan {
    ...
    init {
        pan[4][4] = Cell(1,"乾","阴德")
        pan[4][3] = Cell(8,"亥","大义", DiZhi(DiZhi.HAI))
        pan[4][2] = Cell(8,"子","地主", DiZhi(DiZhi.ZI))
        pan[4][1] = Cell(3,"丑","阳德", DiZhi(DiZhi.CHOU))
        pan[4][0] = Cell(3,"艮","和德")
        pan[3][0] = Cell(4,"寅","吕申", DiZhi(DiZhi.YIN))
        pan[2][0] = Cell(4,"卯","高丛", DiZhi(DiZhi.MAO))
        pan[1][0] = Cell(9,"辰","太阳", DiZhi(DiZhi.CHEN))
        pan[0][0] = Cell(9,"巽","大炅")
        pan[0][1] = Cell(2,"巳","大神", DiZhi(DiZhi.SI))
        pan[0][2] = Cell(2,"午","大威", DiZhi(DiZhi.WU))
        pan[0][3] = Cell(7,"未","天道", DiZhi(DiZhi.WEI))
        pan[0][4] = Cell(7,"坤","大武")
        pan[1][4] = Cell(6,"申","武德", DiZhi(DiZhi.SHEN))
        pan[2][4] = Cell(6,"酉","太簇", DiZhi(DiZhi.YOU))
        pan[3][4] = Cell(1,"戌","阴主", DiZhi(DiZhi.XU))
        var cell17 = pan[2][2]
        cell17.gongNum = 5
    }
